...
CREATE TABLE IF NOT EXISTS `item` (
	...
	`owner-name` varchar(255) COMMENT 'Name of the owner of this item',
	`owner-link` varchar(255) COMMENT 'Link to the profile page of the owner of this item',
	`owner-avatar` varchar(255) COMMENT 'Link to the avatar picture of the owner of this item',
	`author-id` int unsigned NOT NULL DEFAULT 0 COMMENT 'Link to the contact table with uid=0 of the author of this item',
	`author-name` varchar(255) COMMENT 'Name of the author of this item',
	`author-link` varchar(255) COMMENT 'Link to the profile page of the author of this item',
	`author-avatar` varchar(255) COMMENT 'Link to the avatar picture of the author of this item',
	...
	`title` varchar(255) COMMENT 'item title',
	`content-warning` varchar(255) COMMENT '',
	`body` mediumtext COMMENT 'item body content',
	`app` varchar(255) COMMENT 'application which generated this item',
	`verb` varchar(100) COMMENT 'ActivityStreams verb',
	`object-type` varchar(100) COMMENT 'ActivityStreams object type',
	`object` text COMMENT 'JSON encoded object structure unless it is an implied object (normal post)',
	`target-type` varchar(100) COMMENT 'ActivityStreams target type if applicable (URI)',
	...
	`plink` varchar(255) COMMENT 'permalink or URL to a displayable copy of the message at its source',
	...
	`location` varchar(255) COMMENT 'text location where this item originated',
	`coord` varchar(255) COMMENT 'longitude/latitude pair representing location where this item originated',
	`allow_cid` mediumtext COMMENT 'Access Control - list of allowed contact.id \'<19><78>\'',
	`allow_gid` mediumtext COMMENT 'Access Control - list of allowed groups',
	`deny_cid` mediumtext COMMENT 'Access Control - list of denied contact.id',
	`deny_gid` mediumtext COMMENT 'Access Control - list of denied groups',
	...
	`rendered-hash` varchar(32) COMMENT '',
