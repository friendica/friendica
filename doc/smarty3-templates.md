...
To render a template use the function *getMarkupTemplate* to load the template and *replace_macros* to replace the macros/variables in the just loaded template file.
