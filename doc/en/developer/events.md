...
### `\Friendica\Event\PageHeaderEvent`

Fired when the page header is rendered, to allow addons to add or change the HTML of the page header.

**Contained data:**
- `getHtml(): string` — the HTML of the page header

**Modifiable:**
- `setHtml(string $html): void` — change the HTML of the page header

### `\Friendica\Event\PageContentTopEvent`

Fired when the content of a page is rendered, to allow addons to add or change the HTML at the top of the content.

**Contained data:**
- `getHtml(): string` — the HTML of the top of the content
...
### `\Friendica\Event\ModHomeContentEvent`

Fired when the content of the home page is rendered, to allow addons to add or change the HTML of the home page content.

**Contained data:**
- `getHtml(): string` — the HTML of the home page content

**Modifiable:**
- `setHtml(string $html): void` — change the HTML of the home page content

### `\Friendica\Event\ModAboutContentEvent`

Fired when the content of the about page is rendered, to allow addons to add or change the HTML of the about page content.

**Contained data:**
- `getHtml(): string` — the HTML of the about page content
