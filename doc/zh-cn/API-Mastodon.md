...
Friendica 提供了在 [官方 Mastodon API 参考文档](https://docs.joinmastodon.org/api/) 中定义的以下端点。
...
请查看[常见问题解答](help/FAQ#clients)以了解支持的应用程序。

### 不支持的应用程序

#### Android

- [Fedilab](https://framagit.org/tom79/fedilab) 自动使用遗留API，请参见问题：https://framagit.org/tom79/fedilab/-/issues/520
- [Mammut](https://github.com/jamiesanson/Mammut) 请求令牌时存在问题，请参见问题https://github.com/jamiesanson/Mammut/issues/19

#### iOS

- [Mast](https://github.com/Beesitech/Mast) 不接受输入的实例名称。 声称它是无效的（消息是：“Not a valid instance (may be closed or dead)”）
- [Toot!](https://apps.apple.com/app/toot/id1229021451)

## 实体

这些接口使用[Mastodon API实体](https://docs.joinmastodon.org/entities/)。
...
这些端点返回空数据，以避免使用第三方客户端时出现错误消息。它们指的是Friendica中尚不存在的功能。
...
这些终端点目前不会被实现。它们涉及到 Friendica 中尚不存在的特性或数据。
