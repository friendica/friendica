	...
	public static function content(array $parameters = [])
	{
		...
		if (strlen($dirLocation)) {
			if ($config->get('config', 'register_policy') === Register::CLOSED) {
				...
				$linkTxt = L10n::t('To accept this invitation, please visit and register at %s or any other public Friendica website.', App::baseUrl()->get())
			...
			if ($config->get('config', 'register_policy') === Register::CLOSED) {
				...
				$linkTxt = L10n::t('To accept this invitation, please visit and register at %s.', App::baseUrl()->get()
		...
		return Renderer::replaceMacros($tpl, [
			...
			'$message'             => [
				...
				. "\r\n" . "\r\n" . App::baseUrl()->get() . '/profile/' . $app->user['nickname']
