	...
	public static function get($filtered = true)
	{
		$arr = [
			...
			'advanced_calendar' => [
				...
				['public_calendar',     DI::l10n()->t('Public Calendar'),         DI::l10n()->t('Public Calendar Events are visible to all Visitors'), false, DI::config()->get('feature_lock', 'public_calendar', false)],
			]
		];
