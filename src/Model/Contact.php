...
class Contact extends BaseObject
{
	...
	public static function remove($id)
	{
		...
		if (!DBM::isResult($contact) || !intval($contact['uid'])) {
			return;
		}
