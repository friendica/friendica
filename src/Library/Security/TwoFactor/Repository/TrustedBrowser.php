...
namespace Friendica\Library\Security\TwoFactor\Repository;
...
class TrustedBrowser
{
	 ...
	 *
	 * @return TwoFactor\Entity\TrustedBrowser|null
	 *
	 * @throws TrustedBrowserPersistenceException
	 * @throws TrustedBrowserNotFoundException
	 */
	public function selectOneByHash(string $cookie_hash): TwoFactor\Entity\TrustedBrowser
	{
		try {
	...
	/**
	 * @param TwoFactor\Entity\TrustedBrowser $trustedBrowser
	 *
	 * @return bool
	 *
	 * @throws TrustedBrowserPersistenceException
	 */
	public function save(TwoFactor\Entity\TrustedBrowser $trustedBrowser): bool
	{
		try {
	 ...
	 * @throws TrustedBrowserPersistenceException
	 */
	public function remove(TwoFactor\Entity\TrustedBrowser $trustedBrowser): bool
	{
		try {
