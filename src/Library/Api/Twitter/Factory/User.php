...
class User extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Twitter\Object\User
	 * @throws HTTPException\InternalServerErrorException
	 * @throws \ImagickException
	 */
	public function createFromContactId(int $contactId, int $uid = 0, bool $skip_status = true, bool $include_user_entities = true): \Friendica\Library\Api\Twitter\Object\User
	{
		...
		return new \Friendica\Library\Api\Twitter\Object\User($publicContact, $apcontact, $userContact, $status, $include_user_entities);
	}
	 ...
	 * @return \Friendica\Library\Api\Twitter\Object\User
	 */
	public function createFromUserId(int $uid, bool $skip_status = true, bool $include_user_entities = true): \Friendica\Library\Api\Twitter\Object\User
	{
