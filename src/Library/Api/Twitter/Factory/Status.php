...
namespace Friendica\Library\Api\Twitter\Factory;
...
class Status extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Twitter\Object\Status
	 * @throws HTTPException\InternalServerErrorException
	 * @throws ImagickException|HTTPException\NotFoundException
	 */
	public function createFromItemId(int $id, int $uid, bool $include_entities = false): \Friendica\Library\Api\Twitter\Object\Status
	{
	 ...
	 * @throws ImagickException|HTTPException\NotFoundException
	 */
	public function createFromUriId(int $uriId, int $uid = 0, bool $include_entities = false): \Friendica\Library\Api\Twitter\Object\Status
	{
		$fields = ['parent-uri-id', 'uri-id', 'uid', 'author-id', 'author-link', 'author-network', 'owner-id', 'causer-id',
			'starred', 'app', 'title', 'body', 'raw-body', 'created', 'network','post-reason', 'language', 'gravity',
			'thr-parent-id', 'parent-author-id', 'parent-author-nick', 'uri', 'plink', 'private', 'vid', 'coord'];
	 ...
	 * @throws ImagickException|HTTPException\NotFoundException
	 */
	private function createFromArray(array $item, int $uid, bool $include_entities): \Friendica\Library\Api\Twitter\Object\Status
	{
		...
		return new \Friendica\Library\Api\Twitter\Object\Status($text, $statusnetHtml, $friendicaHtml, $item, $author, $owner, $retweeted, $quoted, $geo, $friendica_activities, $entities, $attachments,  $friendica_comments, $liked);
	}
}
