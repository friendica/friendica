...
class DirectMessage extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Twitter\Object\DirectMessage
	 */
	public function createFromMailId(int $id, int $uid, string $text_mode = ''): \Friendica\Library\Api\Twitter\Object\DirectMessage
	{
		...
		return new \Friendica\Library\Api\Twitter\Object\DirectMessage($mail, $sender, $recipient, $text, $title);
	}
}
