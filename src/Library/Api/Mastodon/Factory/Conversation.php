...
class Conversation extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\Conversation
	 * @throws ImagickException|HTTPException\InternalServerErrorException|HTTPException\NotFoundException
	 */
	public function createFromConvId(int $id): \Friendica\Library\Api\Mastodon\Object\Conversation
	{
		$accounts    = [];
		$unread      = false;
		$last_status = null;
		...
		return new \Friendica\Library\Api\Mastodon\Object\Conversation($id, $accounts, $unread, $last_status);
	}
}
