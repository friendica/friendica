...
class Card extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\Card
	 * @throws HTTPException\InternalServerErrorException
	 * @throws \ImagickException*@throws \Exception
	 */
	public function createFromUriId(int $uriId): \Friendica\Library\Api\Mastodon\Object\Card
	{
		...
		return new \Friendica\Library\Api\Mastodon\Object\Card($data);
	}
}
