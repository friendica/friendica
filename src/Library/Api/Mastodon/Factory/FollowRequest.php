...
use Friendica\Library\Contact\Introduction\Entity\Introduction;
...
class FollowRequest extends BaseFactory
{
	 ...
	 * @return \Friendica\Library\Api\Mastodon\Object\FollowRequest
	 * @throws ImagickException|HTTPException\InternalServerErrorException
	 */
	public function createFromIntroduction(Introduction $introduction): \Friendica\Library\Api\Mastodon\Object\FollowRequest
	{
		...
		return new \Friendica\Library\Api\Mastodon\Object\FollowRequest($this->baseUrl, $introduction->id, $publicContact, $apContact, $userContact);
	}
}
