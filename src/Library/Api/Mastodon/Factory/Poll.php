...
class Poll extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\Poll
	 * @throws HTTPException\NotFoundException
	 */
	public function createFromId(int $id, int $uid = 0): \Friendica\Library\Api\Mastodon\Object\Poll
	{
		...
		return new \Friendica\Library\Api\Mastodon\Object\Poll($question, $options, $expired, $votes, $ownvotes);
	}
}
