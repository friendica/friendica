...
class Account extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\Account
	 * @throws HTTPException\InternalServerErrorException
	 * @throws ImagickException|HTTPException\NotFoundException
	 */
	public function createFromContactId(int $contactId, int $uid = 0): \Friendica\Library\Api\Mastodon\Object\Account
	{
	 ...
	 * @throws ImagickException|HTTPException\NotFoundException
	 */
	public function createFromUriId(int $contactUriId, int $uid = 0): \Friendica\Library\Api\Mastodon\Object\Account
	{
		...
		$fields = new \Friendica\Library\Api\Mastodon\Collection\Fields();
		...
		return new \Friendica\Library\Api\Mastodon\Object\Account($this->baseUrl, $account, $fields);
	}
	 ...
	 */
	public function createFromUserId(int $userId): \Friendica\Library\Api\Mastodon\Object\Account
	{
