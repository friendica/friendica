...
class Application extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\Application
	 * @throws UnprocessableEntityException
	 */
	public function createFromApplicationId(int $id): \Friendica\Library\Api\Mastodon\Object\Application
	{
		...
		return new \Friendica\Library\Api\Mastodon\Object\Application(
			$application['name'],
