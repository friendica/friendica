...
class ScheduledStatus extends BaseFactory
{
	 ...
	 *
	 * @return \Friendica\Library\Api\Mastodon\Object\ScheduledStatus
	 * @throws HTTPException\InternalServerErrorException
	 */
	public function createFromDelayedPostId(int $id, int $uid): \Friendica\Library\Api\Mastodon\Object\ScheduledStatus
	{
		...
		return new \Friendica\Library\Api\Mastodon\Object\ScheduledStatus($delayed_post, $parameters, $media_ids, $media_attachments, $in_reply_to_id);
	}
}
