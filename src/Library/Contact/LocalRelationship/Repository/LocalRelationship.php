...
namespace Friendica\Library\Contact\LocalRelationship\Repository;

use Friendica\Library\Contact\LocalRelationship\Entity;
use Friendica\Library\Contact\LocalRelationship\Exception;
use Friendica\Library\Contact\LocalRelationship\Factory;
use Friendica\Database\Database;
use Friendica\Network\HTTPException;
use Psr\Log\LoggerInterface;

class LocalRelationship extends \Friendica\Library\BaseRepository
{
