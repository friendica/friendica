...
class App
{
    ...
    public function get_cached_avatar_image($avatar_image)
    {
        return $avatar_image;
     ...
     */
    public function remove_baseurl($url)
    {
     ...
     * @param string $name
     */
    public function register_template_engine($class, $name = '')
    {
        if ($name==="") {
     ...
     */
    public function template_engine($name = '')
    {
        if ($name!=="") {
     ...
     */
    public function remove_inactive_processes()
    {
    ...
    public function mark_timestamp($mark)
    {
     ...
     */
    public function is_already_running($taskname, $task = "", $timeout = 540)
    {
