...
require_once 'view/theme/larpnet_notifications/php/Image.php';
...
function theme_content(AppHelper $appHelper): string
{
	...
	$arr = [
		'scheme'              => larpnet_notifications_scheme_get_current_for_user(DI::userSession()->getLocalUserId()),
		'share_string'        => '',
...
function larpnet_form($arr)
{
	...
	$scheme_info = larpnet_notifications_get_scheme_info($arr['scheme']);
	...
	$ctx = [
		...
		'$scheme'                 => ['larpnet_scheme', DI::l10n()->t('Appearance'), $arr['scheme'], larpnet_notifications_scheme_get_list()],
