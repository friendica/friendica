{{*
  ...
  *}}
<script type="text/javascript" src="view/theme/larpnet_notifications/js/mod_admin.js?v={{$VERSION}}"></script>
<link rel="stylesheet" href="view/theme/larpnet_notifications/css/mod_admin.css?v={{$VERSION}}" type="text/css" media="screen"/>
