{{*
  ...
  *}}
{{if !$update}}<script type="text/javascript" src="view/theme/larpnet_notifications/frameworks/jquery-color/jquery.color.js?v={{$VERSION}}"></script>{{/if}}
{{if $mode == display}}<script type="text/javascript" src="view/theme/larpnet_notifications/js/mod_display.js?v={{$VERSION}}"></script>{{/if}}
