...
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/bootstrap/css/bootstrap.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/bootstrap/css/bootstrap-theme.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet" href="view/asset/fork-awesome/css/fork-awesome.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/jasny/css/jasny-bootstrap.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/bootstrap-select/css/bootstrap-select.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/ekko-lightbox/ekko-lightbox.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/justifiedGallery/justifiedGallery.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet"
	href="view/theme/larpnet_notifications/frameworks/bootstrap-toggle/css/bootstrap-toggle.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet" href="view/theme/larpnet_notifications/font/open_sans/open-sans.css?v={{$VERSION}}"
	type="text/css" media="screen" />
<link rel="stylesheet" href="view/js/fancybox/jquery.fancybox.min.css?v={{$VERSION}}"
	type="text/css" media="screen" />

{{* own css files *}}
<link rel="stylesheet" href="view/theme/larpnet_notifications/css/hovercard.css?v={{$VERSION}}" type="text/css"
	media="screen" />
<link rel="stylesheet" href="view/theme/larpnet_notifications/css/font-awesome.custom.css?v={{$VERSION}}"
	type="text/css" media="screen" />
...
<![endif]-->
	...
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/bootstrap/js/bootstrap.min.js?v={{$VERSION}}"></script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/jasny/js/jasny-bootstrap.custom.js?v={{$VERSION}}"></script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/bootstrap-select/js/bootstrap-select.min.js?v={{$VERSION}}">
	</script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/ekko-lightbox/ekko-lightbox.min.js?v={{$VERSION}}"></script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/justifiedGallery/jquery.justifiedGallery.min.js?v={{$VERSION}}">
	</script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js?v={{$VERSION}}">
	</script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/flexMenu/flexmenu.custom.js?v={{$VERSION}}"></script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/jquery-scrollspy/jquery-scrollspy.js?v={{$VERSION}}">
	</script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/autosize/autosize.min.js?v={{$VERSION}}"></script>
	<script type="text/javascript"
		src="view/theme/larpnet_notifications/frameworks/sticky-kit/jquery.sticky-kit.min.js?v={{$VERSION}}"></script>

	{{* own js files *}}
	<script type="text/javascript" src="view/theme/larpnet_notifications/js/theme.js?v={{$VERSION}}"></script>
	<script type="text/javascript" src="view/theme/larpnet_notifications/js/modal.js?v={{$VERSION}}"></script>
	{{if ! $block_public}}
		<script type="text/javascript" src="view/theme/larpnet_notifications/js/hovercard.js?v={{$VERSION}}"></script>
	{{/if}}
	<script type="text/javascript" src="view/theme/larpnet_notifications/js/textedit.js?v={{$VERSION}}"></script>
