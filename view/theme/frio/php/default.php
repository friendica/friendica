...
<?php
    ...
    if ($minimal) {
        ?>
		<section class="minimal" style="margin:0px!important; padding:0px!important; float:none!important;display:block!important;"><?php if (x($page, 'content')) {
            echo $page['content'];
        } ?>
...
<?php 
    } ?> <!-- End of condition if $minal else the rest -->
</body>
