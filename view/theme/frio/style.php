...
$nav_bg           = (empty($nav_bg)           ? '#3b5998'      : $nav_bg);
$nav_icon_color   = (empty($nav_icon_color)   ? '#ffffff'      : $nav_icon_color);
$link_color       = (empty($link_color)       ? '#365899'      : $link_color);
$background_color = (empty($background_color) ? '#e9ebee'      : $background_color);
