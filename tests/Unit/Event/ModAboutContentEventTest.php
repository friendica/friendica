...
class ModAboutContentEventTest extends TestCase
{
	private function createEvent(): ModAboutContentEvent
	{
		return new ModAboutContentEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ModAboutContentEvent::NAME, $event->getName());
	}
