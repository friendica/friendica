...
class FooterEventTest extends TestCase
{
	private function createEvent(): FooterEvent
	{
		return new FooterEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(FooterEvent::NAME, $event->getName());
	}
