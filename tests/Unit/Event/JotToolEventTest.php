...
class JotToolEventTest extends TestCase
{
	private function createEvent(): JotToolEvent
	{
		return new JotToolEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(JotToolEvent::NAME, $event->getName());
	}
