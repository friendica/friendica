...
class UnfollowContactEventTest extends TestCase
{
	private function createEvent(): UnfollowContactEvent
	{
		return new UnfollowContactEvent(['url' => 'https://example.com', 'name' => 'original'], 42);
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(UnfollowContactEvent::NAME, $event->getName());
	}
