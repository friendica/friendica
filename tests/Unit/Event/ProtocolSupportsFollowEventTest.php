...
class ProtocolSupportsFollowEventTest extends TestCase
{
	private function createEvent(): ProtocolSupportsFollowEvent
	{
		return new ProtocolSupportsFollowEvent('activitypub');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ProtocolSupportsFollowEvent::NAME, $event->getName());
	}
