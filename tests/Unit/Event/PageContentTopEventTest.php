...
class PageContentTopEventTest extends TestCase
{
	private function createEvent(): PageContentTopEvent
	{
		return new PageContentTopEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(PageContentTopEvent::NAME, $event->getName());
	}
