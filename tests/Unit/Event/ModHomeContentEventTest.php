...
class ModHomeContentEventTest extends TestCase
{
	private function createEvent(): ModHomeContentEvent
	{
		return new ModHomeContentEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ModHomeContentEvent::NAME, $event->getName());
	}
