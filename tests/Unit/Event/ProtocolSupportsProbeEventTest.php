...
class ProtocolSupportsProbeEventTest extends TestCase
{
	private function createEvent(): ProtocolSupportsProbeEvent
	{
		return new ProtocolSupportsProbeEvent('activitypub');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ProtocolSupportsProbeEvent::NAME, $event->getName());
	}
