...
class AddonSettingsPostEventTest extends TestCase
{
	private function createEvent(): AddonSettingsPostEvent
	{
		return new AddonSettingsPostEvent([
			'irc-submit' => 'foo',
		]);
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(AddonSettingsPostEvent::NAME, $event->getName());
	}
