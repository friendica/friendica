...
class ContactBlockEndEventTest extends TestCase
{
	private function createEvent(): ContactBlockEndEvent
	{
		return new ContactBlockEndEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ContactBlockEndEvent::NAME, $event->getName());
	}
