...
class ConnectorSettingsPostEventTest extends TestCase
{
	private function createEvent(): ConnectorSettingsPostEvent
	{
		return new ConnectorSettingsPostEvent([
			'diaspora-submit' => 'foo',
		]);
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ConnectorSettingsPostEvent::NAME, $event->getName());
	}
