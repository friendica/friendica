...
class ModProfileContentEventTest extends TestCase
{
	private function createEvent(): ModProfileContentEvent
	{
		return new ModProfileContentEvent('<html>');
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(ModProfileContentEvent::NAME, $event->getName());
	}
