...
class BlockContactEventTest extends TestCase
{
	private function createEvent(): BlockContactEvent
	{
		return new BlockContactEvent(['url' => 'https://example.com', 'name' => 'original'], 42);
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(BlockContactEvent::NAME, $event->getName());
	}
