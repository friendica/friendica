...
class RevokeFollowContactEventTest extends TestCase
{
	private function createEvent(): RevokeFollowContactEvent
	{
		return new RevokeFollowContactEvent(['url' => 'https://example.com', 'name' => 'original'], 42);
	}
	...
	public function testGetNameReturnsName(): void
	{
		...
		$this->assertSame(RevokeFollowContactEvent::NAME, $event->getName());
	}
