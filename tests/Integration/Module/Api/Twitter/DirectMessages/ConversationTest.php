...
final class ConversationTest extends ApiTestCase
{
	public function testApiDirectMessagesBoxWithConversation(): void
	{
		...
		$request = (new ServerRequest('GET', 'https://friendica.local/api/direct_messages/conversation'))
			->withQueryParams(['format' => 'json', 'friendica_verbose' => 'true']);
